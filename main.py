...
def evaluate_calculation():
    ...
    try:
        ...
        clear_fieled()
        text_results.insert(1.0,"Not Possible")
...
text_results = tk.Text(root, height=2, width=16, font=("Times New Roman",24))
...
btn_mul = tk.Button(root, text="*", command=lambda: add_to_calculation("*"), width=5, font=("Times New Roman", 14))
btn_mul.grid(row=4, column=4)
btn_div = tk.Button(root, text="/", command=lambda: add_to_calculation("/"), width=5, font=("Times New Roman", 14))
btn_div.grid(row=5, column=4)
btn_open = tk.Button(root, text="(", command=lambda: add_to_calculation("("), width=5, font=("Times New Roman", 14))
btn_open.grid(row=5, column=1)
btn_close = tk.Button(root, text=")", command=lambda: add_to_calculation(")"), width=5, font=("Times New Roman", 14))
btn_close.grid(row=5, column=3)
btn_clear = tk.Button(root, text="C", command= clear_fieled, width=11, font=("Times New Roman", 14))
btn_clear.grid(row=6, column=1, columnspan=2)
btn_equal = tk.Button(root, text="=", command= evaluate_calculation, width=11, font=("Times New Roman", 14))
